        ...
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <div class="card-deck-wrapper">
                    <div class="card-deck">
                        <div class="card">
                            <div class="card-ribbon card-ribbon-bottom card-ribbon-left bg-primary text-white">Promoção</div>
                        ...
                        <div class="card">
                            <img class="card-img-top img-fluid" src="assets/img/backgrounds/picjumbo.com_P1010057.jpg" alt="Card image cap">
                            <div class="card-block">
                                <h4 class="card-title">
                                    Elaboração de Rótulos de Embalagens
                                </h4>
                                <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                            </div>
                        </div>
                        <div class="card">
                            <img class="card-img-top img-fluid" src="assets/img/backgrounds/picjumbo.com_P1010062.jpg" alt="Card image cap">
                            <div class="card-block">
                                <h4 class="card-title">
                                    Melhoria de conservação dos alimentos
                                </h4>
                ...
                <div class="mt-4 owl-dots-center owl-nav-over" data-toggle="owl-carousel" data-owl-carousel-settings='{"responsive":{"0":{"items":1}, "600":{"items":1, "stagePadding":90, "margin":90}}, "center":true, "dots":true, "autoHeight":true}'>
                    ...
                    <blockquote class="blockquote-bubble">
                        ...
                        <small>
                            <img src="assets/img/team/bono.jpg" alt="Picture of Dave" class="img-circle d-inline-block" />
                    ...
                    <blockquote class="blockquote-bubble">
                        ...
                        <small>
                            <img src="assets/img/team/jimi.jpg" alt="Picture of Jo" class="img-circle d-inline-block" />
                    ...
                    <blockquote class="blockquote-bubble">
                        ...
                        <small>
                            <img src="assets/img/team/obama.jpg" alt="Picture of Jo" class="img-circle d-inline-block" />
                    ...
                    <blockquote class="blockquote-bubble">
                        ...
                        <small>
                            <img src="assets/img/team/steve.jpg" alt="Picture of Dave" class="img-circle d-inline-block" />
                    ...
                    <blockquote class="blockquote-bubble">
                        ...
                        <small>
                            <img src="assets/img/team/obama.jpg" alt="Picture of Erin" class="img-circle d-inline-block" />
                    ...
                    <blockquote class="blockquote-bubble">
                        ...
                        <small>
                            <img src="assets/img/team/steve.jpg" alt="Picture of Tom" class="img-circle d-inline-block" />
