            ...
            <div class="col-md-12">
                ...
                {{ Form::open(array('action' => 'ContatoController@contato', 'role' => 'form')) }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::select('assunto',['Contato' => 'Contato', 'Cotação' => 'Cotação'], null, array('class'=>'form-control')) }}
                        <small id="contact-email-help" class="form-text text-muted">Informe qual assunto da sua mensagem</small>
                    </div>
