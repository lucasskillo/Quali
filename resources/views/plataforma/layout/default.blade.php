...
<head>
    ...
    <link href="assets/css/plataforma/Content/fonts/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-diamond"></i> <span class="nav-label">Home</span></a>
                </li>
                <li>
                ...
                <li class="landing_link">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="#">Lista de Workshop</a></li>
